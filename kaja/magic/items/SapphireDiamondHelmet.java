...
public class SapphireDiamondHelmet extends ItemArmor {

	public SapphireDiamondHelmet(int par1,
			EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
		super(par1, par2EnumArmorMaterial, par3, par4);
		
		setUnlocalizedName("sapphireDiamondHelmet");
	...
	public void registerIcons(IconRegister reg) {
		this.itemIcon = reg.registerIcon("magic:SapphireHelmet");
	}
