...
public class FireOpalHoe extends ItemHoe {

	 public FireOpalHoe(int id, EnumToolMaterial enumToolMaterial) {
		 super(id, enumToolMaterial);
	     
	     setUnlocalizedName("fireOpalHoe");
	     func_111206_d("magic:FireOpalHoe");
	  }
