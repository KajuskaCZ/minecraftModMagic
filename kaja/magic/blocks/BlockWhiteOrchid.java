...
public class BlockWhiteOrchid extends BlockFlower {
	
	public BlockWhiteOrchid(int id, Material material) {
		super(id, material);
		

		setUnlocalizedName("whiteOrchid");
		float f = 0.2F;
        this.setBlockBounds(0.5F - f, 0.0F, 0.5F - f, 0.6F + f, 0.7F, 0.6F + f);
		this.setCreativeTab(CreativeTabs.tabDecorations);
		this.setStepSound(soundGrassFootstep);
		func_111022_d("magic:WhiteOrchid");
	}
