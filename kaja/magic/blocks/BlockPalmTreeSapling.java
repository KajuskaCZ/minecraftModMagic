...
public class BlockPalmTreeSapling extends BlockFlower {
	...
	public BlockPalmTreeSapling(int par1, Material par2Material) {
		super(par1, par2Material);
		setUnlocalizedName("palmTreeSapling");
        this.setBlockBounds(0.1F, 0.0F, 0.1F, 0.9F, 0.8F, 0.9F);
		this.setCreativeTab(CreativeTabs.tabDecorations);
		func_111022_d("magic:PalmTreeSapling");
	...
	protected boolean canThisPlantGrowOnThisBlockID(int par1) {
		return par1 == Block.grass.blockID || par1 == Block.dirt.blockID || par1 == Block.tilledField.blockID
				|| par1 == Magic.goldenGrass.blockID || par1 == Magic.darkGrass.blockID || par1 == Block.sand.blockID;
	 }
	  
	public void growTree(World par1World, int par2, int par3, int par4, Random par5Random) { 
		 
	     if (!TerrainGen.saplingGrowTree(par1World, par5Random, par2, par3, par4)) return;
	     Object object = new PalmTreeGenerator();
