...
public class BlockGoldenTallGrass extends BlockFlower implements IShearable {

	public BlockGoldenTallGrass(int id, Material material) {
		super(id, material);
		

		setUnlocalizedName("goldenTallGrass");
		this.setBlockBounds(0.1F, 0.0F, 0.1F, 0.9F, 0.8F, 0.9F);
		this.setCreativeTab(CreativeTabs.tabDecorations);
		this.setStepSound(soundGrassFootstep);
		func_111022_d("magic:GoldenTallGrass");
	}
