...
public class BlockMediumBlackberryBush extends BlockContainer {

	public BlockMediumBlackberryBush(int par1, Material par2Material) {
		super(par1, par2Material);
		
		setUnlocalizedName("mediumBlackberryBush");
